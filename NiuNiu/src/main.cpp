...
static	const quint16		gameId			= DJGAME_NIUNIU;
static	QString				gameName		= "NiuNiu";
static 	NiuNiuController*	gameController	= 0;
...
{
	if ( 0 == gameController )
		gameController	= new NiuNiuController( gameId, gameName, hallInterface );
}
