...
static	const quint16		gameId			= DJGAME_UPGRADE;
static	QString				gameName		= "Upgrade";
static 	TLJController		*gameController	= 0;
...
{	
	...
	return translator.translate( "TLJController", gameName.toAscii() );
}
extern "C" MY_EXPORT void CreateGameController( const DJHallInterface &hallInterface )
{
	if ( 0 == gameController )
		gameController	= new TLJController( gameId, gameName, hallInterface );
}
