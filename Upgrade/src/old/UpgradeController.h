...
class UpgradeController : public DJGameController
{
	Q_OBJECT
public:
	UpgradeController( quint16 gameId, const QString& gameName, const DJHallInterface& hallInterface, QObject *parent = 0 );
	~UpgradeController();
