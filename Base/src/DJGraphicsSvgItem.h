...
#ifndef	DJGRAPHICSSVGITEM_H
#define DJGRAPHICSSVGITEM_H

#include <QtGui>
#include <QtSvg>
#include "DJBaseGlobal.h"

class DJ_BASE_EXPORT DJGraphicsSvgItem : public QGraphicsSvgItem
{
public:
	enum { DJGraphicsSvgItemType = UserType + 6 };
	
	DJGraphicsSvgItem( QGraphicsItem * parent = 0, bool isMatrimoveMode = true );
	DJGraphicsSvgItem( const QString & fileName, QGraphicsItem * parent = 0, bool isMatrimoveMode = true );
	virtual ~DJGraphicsSvgItem();
