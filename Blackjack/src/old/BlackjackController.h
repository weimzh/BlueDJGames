...
class BlackjackController : public DJGameController
{
	Q_OBJECT
public:
	BlackjackController( quint16 gameId, const QString& gameName, const DJHallInterface& hallInterface, QObject *parent = 0 );
	~BlackjackController();
