...
#ifndef GZCONTROLLER_H
#define GZCONTROLLER_H
...
class GZController : public DJGameController
{
	Q_OBJECT
public:
	GZController( quint16 gameId, const QString& gameName, const DJHallInterface& hallInterface, QObject *parent = 0 );
	~GZController();
