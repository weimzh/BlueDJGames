...
#ifndef GONGZHUCONTROLLER_H
#define GONGZHUCONTROLLER_H
...
class GongZhuController : public DJGameController
{
	Q_OBJECT
public:
	GongZhuController( quint16 gameId, const QString& gameName, const DJHallInterface& hallInterface, QObject *parent = 0 );
	~GongZhuController();
