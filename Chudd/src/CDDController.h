...
#ifndef CDDCONTROLLER_H
#define CDDCONTROLLER_H
...
class CDDController : public DJGameController
{
	Q_OBJECT
public:
	CDDController( quint16 gameId, const QString& gameName, const DJHallInterface& hallInterface, QObject *parent = 0 );
	~CDDController();
