...
static	const quint16		gameId			= DJGAME_CHUDD;
static	QString				gameName		= "Chudd";
static 	CDDController		*gameController	= 0;
...
{	
	...
	return translator.translate( "CDDController", gameName.toAscii() );
}
extern "C" MY_EXPORT void CreateGameController( const DJHallInterface &hallInterface )
{
	if ( 0 == gameController )
		gameController	= new CDDController( gameId, gameName, hallInterface );
}
