...
#ifndef ChuddCONTROLLER_H
#define ChuddCONTROLLER_H
...
class ChuddController : public DJGameController
{
	Q_OBJECT
public:
	ChuddController( quint16 gameId, const QString& gameName, const DJHallInterface& hallInterface, QObject *parent = 0 );
	~ChuddController();
