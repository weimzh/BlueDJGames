...
#ifndef INTERLINKCONTROLLER_H
#define INTERLINKCONTROLLER_H
...
class InterlinkController : public DJGameController
{
	Q_OBJECT
public:
	InterlinkController( quint16 gameId, const QString& gameName, const DJHallInterface& hallInterface, QObject *parent = 0 );
	~InterlinkController();
