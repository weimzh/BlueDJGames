...
static	const quint16		gameId			= DJGAME_DOMINO;
static	QString				gameName		= "Interlink";
static 	DominoController	*gameController	= 0;
...
{	
	...
	return translator.translate( "DominoController", gameName.toAscii() );
}
extern "C" MY_EXPORT void CreateGameController( const DJHallInterface &hallInterface )
{
	if ( 0 == gameController )
		gameController	= new DominoController( gameId, gameName, hallInterface );
}
