...
class DominoController : public DJGameController
{
	Q_OBJECT
public:
	DominoController( quint16 gameId, const QString& gameName, const DJHallInterface& hallInterface, QObject *parent = 0 );
	~DominoController();
