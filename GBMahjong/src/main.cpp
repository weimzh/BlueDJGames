...
static	const quint16		gameId			= DJGAME_GBMAHJONG;
static	QString				gameName		= "Mahjong";
static 	GBMJController*		gameController	= 0;
...
{
	if ( 0 == gameController )
		gameController	= new GBMJController( gameId, gameName, hallInterface );
}
