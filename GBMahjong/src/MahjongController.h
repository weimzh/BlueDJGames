...
#ifndef MAHJONGCONTROLLER_H
#define MAHJONGCONTROLLER_H
...
class MahjongController : public DJGameController
{
	Q_OBJECT
public:
	MahjongController( quint16 gameId, const QString& gameName, const DJHallInterface& hallInterface, QObject *parent = 0 );
	~MahjongController();
