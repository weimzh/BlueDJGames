...
#ifndef GBMJCONTROLLER_H
#define GBMJCONTROLLER_H
...
class GBMJController : public DJGameController
{
	Q_OBJECT
public:
	GBMJController( quint16 gameId, const QString& gameName, const DJHallInterface& hallInterface, QObject *parent = 0 );
	~GBMJController();
