...
#ifndef XQCONTROLLER_H
#define XQCONTROLLER_H
...
class XQController : public DJGameController
{
	Q_OBJECT
public:
	XQController( quint16 gameId, const QString& gameName, const DJHallInterface& hallInterface, QObject *parent = 0 );
	~XQController();
