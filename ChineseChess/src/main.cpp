...
static	const quint16		gameId			= DJGAME_XIANGQI;
static	QString				gameName		= "ChineseChess";
static 	XQController		*gameController	= 0;
...
{	
	...
	return translator.translate( "XQController", gameName.toAscii() );
}
extern "C" MY_EXPORT void CreateGameController( const DJHallInterface &hallInterface )
{
	if ( 0 == gameController )
		gameController	= new XQController( gameId, gameName, hallInterface );
}
