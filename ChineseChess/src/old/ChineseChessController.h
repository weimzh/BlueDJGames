...
#ifndef CHINESECHESSCONTROLLER_H
#define CHINESECHESSCONTROLLER_H
...
class ChineseChessController : public DJGameController
{
	Q_OBJECT
public:
	ChineseChessController( quint16 gameId, const QString& gameName, const DJHallInterface& hallInterface, QObject *parent = 0 );
	~ChineseChessController();
