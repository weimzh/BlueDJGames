...
static	const quint16		gameId			= DJGAME_GDMJ;
static	QString				gameName		= "GDMahjong";
static 	GDMJController		*gameController	= 0;
...
{	
	...
	return translator.translate( "GDMJController", gameName.toAscii() );
}
extern "C" MY_EXPORT void CreateGameController( const DJHallInterface &hallInterface )
{
	if ( 0 == gameController )
		gameController	= new GDMJController( gameId, gameName, hallInterface );
}
