...
static	const quint16		gameId			= DJGAME_GOBANG;
static	QString				gameName		= "Renju";
static 	RenjuController*	gameController	= 0;
...
{	
	...
	return translator.translate( "RenjuController", gameName.toAscii() );
}
extern "C" MY_EXPORT void CreateGameController( const DJHallInterface &hallInterface )
{
	if ( 0 == gameController )
		gameController	= new RenjuController( gameId, gameName, hallInterface );
}
