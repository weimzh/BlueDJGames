...
#ifndef JQCONTROLLER_H
#define JQCONTROLLER_H
...
class JQController : public DJGameController
{
	Q_OBJECT
public:
	JQController( quint16 gameId, const QString& gameName, const DJHallInterface& hallInterface, QObject *parent = 0 );
	~JQController();
