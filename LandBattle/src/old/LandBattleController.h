...
#ifndef LANDBATTLECONTROLLER_H
#define LANDBATTLECONTROLLER_H
...
class LandBattleController : public DJGameController
{
	Q_OBJECT
public:
	LandBattleController( quint16 gameId, const QString& gameName, const DJHallInterface& hallInterface, QObject *parent = 0 );
	~LandBattleController();
