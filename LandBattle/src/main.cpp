...
static	const quint16		gameId			= DJGAME_JUNQI;
static	QString				gameName		= "LandBattle";
static 	JQController		*gameController	= 0;
...
{	
	...
	return translator.translate( "JQController", gameName.toAscii() );
}
extern "C" MY_EXPORT void CreateGameController( const DJHallInterface &hallInterface )
{
	if ( 0 == gameController )
		gameController	= new JQController( gameId, gameName, hallInterface );
}
