...
static	const quint16		gameId			= DJGAME_SUOHA;
static	QString				gameName		= "Suoha";
static 	SuohaController*	gameController	= 0;
...
{	
	...
	return translator.translate( "SuohaController", gameName.toAscii() );
}
extern "C" MY_EXPORT void CreateGameController( const DJHallInterface &hallInterface )
{
	if ( 0 == gameController )
		gameController	= new SuohaController( gameId, gameName, hallInterface );
}
