...
#ifndef SUOHACONTROLLER_H
#define SUOHACONTROLLER_H
...
class SuohaController : public DJGameController
{
	Q_OBJECT
public:
	SuohaController( quint16 gameId, const QString& gameName, const DJHallInterface& hallInterface, QObject *parent = 0 );
	~SuohaController();
