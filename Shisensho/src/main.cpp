...
static	const quint16		gameId			= DJGAME_SHISENSHO;
static	QString				gameName		= "Shisensho";
static 	LLKController*	gameController	= 0;
...
{	
	...
	return translator.translate( "LLKController", gameName.toAscii() );
}
extern "C" MY_EXPORT void CreateGameController( const DJHallInterface &hallInterface )
{
	if ( 0 == gameController )
		gameController	= new LLKController( gameId, gameName, hallInterface );
}
