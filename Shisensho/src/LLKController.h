...
#ifndef LLKCONTROLLER_H
#define LLKCONTROLLER_H
...
class LLKController : public DJGameController
{
	Q_OBJECT
public:
	LLKController( quint16 gameId, const QString& gameName, const DJHallInterface& hallInterface, QObject *parent = 0 );
	~LLKController();
