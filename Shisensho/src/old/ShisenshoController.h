...
#ifndef SHISENSHOCONTROLLER_H
#define SHISENSHOCONTROLLER_H
...
class ShisenshoController : public DJGameController
{
	Q_OBJECT
public:
	ShisenshoController( quint16 gameId, const QString& gameName, const DJHallInterface& hallInterface, QObject *parent = 0 );
	~ShisenshoController();
