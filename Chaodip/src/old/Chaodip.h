...
class ChaodipDesktop : public DJGamePokerDesktop
{
	Q_OBJECT
	public :
		ChaodipDesktop(QWidget* parent,DJGamePanel *panel);
		~ChaodipDesktop();
		...
		virtual QImage GetCardPicture(quint8 chCard,quint8 chView,qreal rate);
...
class  ChaodipPanel : public DJGamePanel
{
	Q_OBJECT
	public : 
		ChaodipPanel( DJGameController *gameController, DJGameRoom *room, const QList<quint32>& userIds, quint8 tableId, quint8 seatId, QWidget * parent = 0, Qt::WFlags f = Qt::Window);
        ~ChaodipPanel();
};
