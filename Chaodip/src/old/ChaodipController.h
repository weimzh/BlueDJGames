...
#ifndef CHAODIPCONTROLLER_H
#define CHAODIPCONTROLLER_H
...
class ChaodipController : public DJGameController
{
	Q_OBJECT
public:
	ChaodipController( quint16 gameId, const QString& gameName, const DJHallInterface& hallInterface, QObject *parent = 0 );
	~ChaodipController();
