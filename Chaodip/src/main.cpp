...
static	const quint16		gameId			= DJGAME_CHAODPI;
static	QString				gameName		= "Chaodip";
static 	CDPController		*gameController	= 0;
...
{	
	...
	return translator.translate( "CDPController", gameName.toAscii() );
}
extern "C" MY_EXPORT void CreateGameController( const DJHallInterface &hallInterface )
{
	if ( 0 == gameController )
		gameController	= new CDPController( gameId, gameName, hallInterface );
}
