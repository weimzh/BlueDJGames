...
class CDPDesktopController : public DJDesktopPokerController
{
	Q_OBJECT
public :
	enum PokerClass{ Unknown, Diamond,Club,Heart,Spade,Trump };
	CDPDesktopController( DJPanelController* panelController, const QSize& size, QWidget *parent );
	~CDPDesktopController();
