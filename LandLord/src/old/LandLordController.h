...
#ifndef LANDLORDCONTROLLER_H
#define LANDLORDCONTROLLER_H
...
class LandLordController : public DJGameController
{
	Q_OBJECT
public:
	LandLordController( quint16 gameId, const QString& gameName, const DJHallInterface& hallInterface, QObject *parent = 0 );
	~LandLordController();
