...
#ifndef TLJCONTROLLER_H
#define TLJCONTROLLER_H
...
class DDZController : public DJGameController
{
	Q_OBJECT
public:
	DDZController( quint16 gameId, const QString& gameName, const DJHallInterface& hallInterface, QObject *parent = 0 );
	~DDZController();
