...
static	const quint16		gameId			= DJGAME_DOUDZHU;
static	QString				gameName		= "LandLord";
static 	DDZController		*gameController	= 0;
...
{	
	...
	return translator.translate( "DDZController", gameName.toAscii() );
}
extern "C" MY_EXPORT void CreateGameController( const DJHallInterface &hallInterface )
{
	if ( 0 == gameController )
		gameController	= new DDZController( gameId, gameName, hallInterface );
}
